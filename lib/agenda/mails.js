...
module.exports = function(agenda) {
  ...
  agenda.define('sendOneWeekBeforeEmail', function(job) {
    ...
    emailer.sendOneWeekReminderEmail({
      recipient: job.attrs.data.email,
      customMessage: [job.attrs.data.firstname + ', on compte sur toi pour la semaine prochaine !', 'Pour rappel, ' + job.attrs.data.org_name + ' t\'attends dans une semaine, ' + job.attrs.data.start_date + ', à ' + job.attrs.data.address, 'À bientôt ! ;)'],
      firstname: job.attrs.data.firstname,
      lastname: job.attrs.data.lastname,
