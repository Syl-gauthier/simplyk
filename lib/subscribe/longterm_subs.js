...
var subscribe = function(volunteer, longterm_id, hostname, callback) {
			...
			Volunteer.findOneAndUpdate({
				...
				if (err) {
					...
					var orgContent = {
						...
						customMessage: [newVolunteer.firstname + ' ' + newVolunteer.lastname + ' s\'est inscrit à votre engagement ' + longtermJ.intitule + ' !', 'Maintenant, tu peux le contacter par courriel : ' + newVolunteer.email, 'Ou par téléphone : ' + newVolunteer.phone]
					};
					var volContent = {
