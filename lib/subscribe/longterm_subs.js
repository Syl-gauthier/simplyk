			...
			Volunteer.findOneAndUpdate({
				...
				if (err) {
					...
					var volContent = {
						...
						customMessage: 'Tu t\' es inscrit à l\'engagement de ' + newOrganism.org_name + ' : ' + longtermJ.intitule +' !<br>' + ' N\'oublie pas d\'enregistrer tes heures de participation à cet engagement ! <br> Cela bénéficiera à la fois à ' + newOrganism.org_name + ' et à toi pour passer aux échelons supérieurs de l\'engagement !'
					};
